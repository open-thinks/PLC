...
public class VehicleTrackOne {
    ...
    public boolean equals(Object that) {
        ...
        VehicleTrackOne other = (VehicleTrackOne) that;
    ...
    public static class Builder {
        private VehicleTrackOne obj;

        public Builder() {
            this.obj = new VehicleTrackOne();
        }
